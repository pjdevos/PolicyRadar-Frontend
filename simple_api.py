#!/usr/bin/env python3
"""
Simple API server that works with our document data
"""
...
def load_all_documents() -> List[Dict[str, Any]]:
    ...
    # Try pickle first
    pickle_file = Path("./vectors/documents.pkl")
    ...
    # Fallback to JSONL
    jsonl_file = Path("./data/items.jsonl")
...
@app.get("/api/health")
def health():
    return {"status": "ok", "documents": len(ALL_DOCS)}
